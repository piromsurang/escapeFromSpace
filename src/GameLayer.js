...
var GameLayer = cc.LayerColor.extend({
    ...
    playBackgroundMusic: function() {
          cc.audioEngine.playMusic( 'res/sounds/myInspiration.mp3', true );
    },

    playCollectItemEffect: function() {
          cc.audioEngine.playEffect( 'res/sounds/collect_item.m4a' );
    },

    playExplosionEffect: function() {
      cc.audioEngine.playEffect( 'res/sounds/explosionEdited.mp3' );
    }
});
